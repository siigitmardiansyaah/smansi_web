				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Koreksi Kehadiran</h2>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row row-card-no-pd">
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">	
									<form method="POST" action="<?php echo base_url('koreksi_absen/list_kelas') ?>">
									<div class="row">
										<div class="col">
											...
											<div class="form-group float-right">
												<button type="submit" value="Kirim" name="btnGenerate" class="btn btn-primary">Lihat Siswa</button>
