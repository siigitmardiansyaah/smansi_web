<!-- Logo Header -->
			<div class="logo-header" data-background-color="blue">
				...
				<a href="<?php echo base_url('') ?>" class="logo">
					<img src="<?php echo base_url('assets/img/logo.png') ?>" height="50" alt="navbar brand" class="navbar-brand">
				</a>
				...
				<div class="container-fluid">
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">						
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<div class="dropdown-menu quick-actions quick-actions-info anisated fadeIn">
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu dropdown-user anisated fadeIn">
