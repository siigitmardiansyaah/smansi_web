				...
				<div class="page-inner">
					<div class="row row-card-no-pd mt--2">
						<div class="text-center col-md-6 mr-auto ml-auto">
							...
							<p>
<<<<<<< HEAD
								<b>SMANSI WEB</b> merupakan singkatan dari <i>Solusi Absensi Cerdas Anti Curang Berbasis QR Code</i>. <br />Sama seperti namanya, SMANSI difungsikan untuk menjadi pengganti dari sistem absensi konvensional yang memakan waktu antrian dan biaya untuk pengadaan lembar kertas absensi.
=======
